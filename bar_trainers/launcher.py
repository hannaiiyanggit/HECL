...
from bar_trainers import method_to_trainer
...
def parse_args():
    ...
    parser.add_argument(
        "--exp_root", type=str, default="exp/bar"
    )
    parser.add_argument('--dset_dir', default="/home/test/Desktop/spurious+contrast/Sebra-master/data/BAR", type=str)
